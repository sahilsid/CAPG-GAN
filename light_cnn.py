...
from tensorflow.keras.layers import Input, Add, Maximum, Dense, Conv2D, Flatten, Lambda, MaxPooling2D, AveragePooling2D, Dropout, Average
...
class LightCNN():
    ...
    def train(self, train_gen, valid_gen=None, optimizer=SGD(lr=0.001, momentum=0.9, decay=0.00004, nesterov=True), classifier_dropout=0.3,
